<?php
class UVC_Recent_Posts_List_Widget extends WP_Widget {

	public function __construct() {
		// widget actual processes
		parent::__construct(
	 		'uvc_rpl_widget', // Base ID
			'UVC Recent Stories List', // Name
			array( 'description' => __( 'Display a list of most recent posts that are not in the top posts list.', 'apevo' ), ) // Args
		);
	}
	...
	public function form( $instance ) {
		$title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : __( 'Recent Stories', 'text_domain' );
		...
		<p><small>This category will be excluded from this list.</small></p>
		<p>
	...
	private function generate_list ( $category='Top Stories', $numberposts = 10 ){
		...
		<?php	
			...
			echo "<ul><li>There are recent post to display here yet!</li></ul>";
		}
	}
...
register_widget( 'UVC_Recent_Posts_List_Widget' );